...
#elif defined hi3531_ds1339
#define DEV_RTC						"/dev/rtc_time"
...
//---------------------------------------------
#else
#error RTC library only supports HI3516 or HI3516A platform
#endif
...
{
#if (defined hi3516) || (defined hi3531_ds1339)
